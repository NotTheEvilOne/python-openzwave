...
from libopenzwave import LogLevel, Options
...
class ZWaveOption(object):
    ...
    def __init__(self, device=None, config_path=None, user_path=None, cmd_line=None):
        ...
        kwargs = { }
        if (self._config_path is not None): kwargs['config_path'] = self._config_path
        if (self._user_path is not None): kwargs['user_path'] = self._user_path
        if (self._cmd_line is not None): kwargs['cmd_line'] = self._cmd_line

        self._options = Options.create(**kwargs)
    ...
    def set_log_file(self, logfile):
        ...
        """
        return self._options.addOptionString("LogFileName", logfile, False)
    ...
    def set_logging(self, status):
        ...
        """
        return self._options.addOptionBool("Logging", status)
    ...
    def set_append_log_file(self, status):
        ...
        """
        return self._options.addOptionBool("AppendLogFile", status)
    ...
    def set_console_output(self, status):
        ...
        """
        return self._options.addOptionBool("ConsoleOutput", status)
    ...
    def set_save_log_level(self, level):
        ...
        """
        return self._options.addOptionInt("SaveLogLevel", getattr(LogLevel, level))
    ...
    def set_queue_log_level(self, level):
        ...
        """
        return self._options.addOptionInt("QueueLogLevel", getattr(LogLevel, level))
    ...
    def set_dump_trigger_level(self, level):
        ...
        """
        return self._options.addOptionInt("DumpTriggerLevel", getattr(LogLevel, level))
    ...
    def set_associate(self, status):
        ...
        """
        return self._options.addOptionBool("Associate", status)
    ...
    def set_exclude(self, commandClass):
        ...
        """
        return self._options.addOptionString("Exclude", commandClass, True)
    ...
    def set_include(self, commandClass):
        ...
        """
        return self._options.addOptionString("Include", commandClass, True)
    ...
    def set_notify_transactions(self, status):
        ...
        """
        return self._options.addOptionBool("NotifyTransactions", status)
    ...
    def set_interface(self, port):
        ...
        """
        return self._options.addOptionString("Interface", port, True)
    ...
    def set_save_configuration(self, status):
        ...
        """
        return self._options.addOptionBool("SaveConfiguration", status)
    ...
    def set_driver_max_attempts(self, attempts):
        ...
        """
        return self._options.addOptionInt("DriverMaxAttempts", attempts)
    ...
    def set_poll_interval(self, interval):
        ...
        """
        return self._options.addOptionInt("PollInterval", interval)
    ...
    def set_interval_between_polls(self, status):
        ...
        """
        return self._options.addOptionBool("IntervalBetweenPolls", status)
    ...
    def set_suppress_value_refresh(self, status):
        ...
        """
        return self._options.addOptionBool("SuppressValueRefresh", status)
    ...
    def set_security_strategy(self, strategy='SUPPORTED'):
        ...
        """
        return self._options.addOptionString("SecurityStrategy", strategy, False)
    ...
    def set_custom_secured_cc(self, custom_cc='0x62,0x4c,0x63'):
        ...
        """
        return self._options.addOptionString("CustomSecuredCC", custom_cc, False)
